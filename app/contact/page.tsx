        ...
        <div className="container-custom">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">Timba con Harryto</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/contact" className="text-primary-600 font-medium border-b-2 border-primary-600 pb-1">
                Contact
              </Link>
      ...
      <footer className="bg-gray-900 text-white section-padding">
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">Timba con Harryto</span>
              </div>
              <p className="text-gray-400 mb-4">
                Timba con Harryto provides professional services and solutions.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Timba con Harryto. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
